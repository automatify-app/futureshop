export default class Theme {
  constructor() {
    ...
    if (this.header) {
      this.bottomActive = this.header.classList.contains(
        'fixed--sticky-bottom'
      );
    }
  ...
  initHeader() {
    ...
    if (
      this.header &&
      (this.header.classList.contains('fixed--headroom') ||
        this.header.classList.contains('fixed--sticky') ||
        this.bottomActive)
    ) {
  ...
  headerOffsetFunc() {
    if (this.main && !this.bottomActive && (!this.hero || !this.heroActive)) {
      this.main.style.paddingTop =
        ...
        this.header.getBoundingClientRect().top +
        'px';
    }
    ...
    if (this.header) {
      ...
      document.body.style.setProperty(
        '--header-ht',
        this.header.getBoundingClientRect().height - 25 + 'px'
      );
    }
